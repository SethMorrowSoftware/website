...
function seedDatabase(PDO $db): void {
    ...
    $products = [
        ...
        [1, 'Complete Skoolie Conversion', 'complete-skoolie-conversion', 'Our flagship full-build package. We take your bus from a bare shell to a fully livable, off-grid home on wheels. Includes custom layout design, insulation, electrical system, plumbing, interior buildout, and finishing touches. Every build is unique to your lifestyle and travel plans.', 'wuzabus_photos/20210508_162602.jpg', '$45,000', '', 'Timeline: 3-6 months, Custom layout design, Full electrical & plumbing, Insulation & vapor barrier, Interior buildout & finishing', 'Custom layout design, Off-grid solar power system, Full kitchen & sleeping area, Climate control system, Premium wood finishes', 'Starting price — varies by bus size & options', 0],
