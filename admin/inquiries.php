...
<div class="admin-page-header">
    ...
    <a href="/admin/inquiries.php?markall=1&csrf=<?php echo e($csrfToken); ?>" class="btn-admin btn-save" onclick="return confirm('Mark all as read?')">
...
<div class="admin-tabs">
    <a href="/admin/inquiries.php?type=all" class="<?php echo $type === 'all' ? 'active' : ''; ?>">All</a>
    <a href="/admin/inquiries.php?type=contacts" class="<?php echo $type === 'contacts' ? 'active' : ''; ?>">Contact Messages (<?php echo count($contacts); ?>)</a>
    <a href="/admin/inquiries.php?type=orders" class="<?php echo $type === 'orders' ? 'active' : ''; ?>">Order Inquiries (<?php echo count($orders); ?>)</a>
</div>
                ...
                <tbody>
                    <?php foreach ($contacts as $c): ?>
                        <tr class="<?php echo !$c['is_read'] ? 'row-unread' : ''; ?>">
                            ...
                            <td class="actions">
                                <a href="/admin/inquiry-view.php?type=contact&id=<?php echo $c['id']; ?>" class="btn-icon" title="View"><i class="fas fa-eye"></i></a>
                                <?php if (!$c['is_read']): ?>
                                    <a href="/admin/inquiries.php?read=<?php echo $c['id']; ?>&table=contacts&csrf=<?php echo e($csrfToken); ?>&type=<?php echo e($type); ?>" class="btn-icon" title="Mark Read"><i class="fas fa-check"></i></a>
                                <?php endif; ?>
                                <a href="/admin/inquiries.php?delete=<?php echo $c['id']; ?>&table=contacts&csrf=<?php echo e($csrfToken); ?>&type=<?php echo e($type); ?>" class="btn-icon btn-danger" title="Delete" onclick="return confirm('Delete?')"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
                ...
                <tbody>
                    <?php foreach ($orders as $o): ?>
                        <tr class="<?php echo !$o['is_read'] ? 'row-unread' : ''; ?>">
                            ...
                            <td class="actions">
                                <a href="/admin/inquiry-view.php?type=order&id=<?php echo $o['id']; ?>" class="btn-icon" title="View"><i class="fas fa-eye"></i></a>
                                <?php if (!$o['is_read']): ?>
                                    <a href="/admin/inquiries.php?read=<?php echo $o['id']; ?>&table=orders&csrf=<?php echo e($csrfToken); ?>&type=<?php echo e($type); ?>" class="btn-icon" title="Mark Read"><i class="fas fa-check"></i></a>
                                <?php endif; ?>
                                <a href="/admin/inquiries.php?delete=<?php echo $o['id']; ?>&table=orders&csrf=<?php echo e($csrfToken); ?>&type=<?php echo e($type); ?>" class="btn-icon btn-danger" title="Delete" onclick="return confirm('Delete?')"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
