...
<div class="admin-page-header">
    ...
    <a href="<?php echo url('admin/container-edit.php'); ?>" class="btn-admin btn-add"><i class="fas fa-plus"></i> Add Container</a>
</div>
        ...
        <tbody>
            <?php foreach ($containers as $c): ?>
                <tr>
                    ...
                    <td class="actions">
                        <a href="<?php echo url('admin/container-edit.php?id=' . $c['id']); ?>" class="btn-icon" title="Edit"><i class="fas fa-edit"></i></a>
                        <a href="<?php echo url('admin/containers.php?delete=' . $c['id'] . '&csrf=' . e($csrfToken)); ?>" class="btn-icon btn-danger" title="Delete" onclick="return confirm('Delete this container?')"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
