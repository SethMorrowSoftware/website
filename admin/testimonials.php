...
<div class="admin-page-header">
    ...
    <a href="<?php echo url('admin/testimonial-edit.php'); ?>" class="btn-admin btn-add"><i class="fas fa-plus"></i> Add Testimonial</a>
</div>
...
<?php if (empty($testimonials)): ?>
    <div class="empty-state"><p>No testimonials yet. <a href="<?php echo url('admin/testimonial-edit.php'); ?>">Add your first testimonial</a>.</p></div>
<?php endif; ?>
